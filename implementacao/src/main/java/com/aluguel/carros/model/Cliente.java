...
public class Cliente extends Usuario {
  ...
  // @jakarta.validation.constraints.Pattern(regexp = "\\d{3}\\.\\d{3}\\.\\d{3}-\\d{2}", message =
  // "CPF inválido")
  private String cpf;
  ...
  private List<EmpregadorCliente> empregadores;
  ...
  public List<EmpregadorCliente> getEmpregadores() {
    return empregadores;
  }

  public void setEmpregadores(List<EmpregadorCliente> empregadores) {
